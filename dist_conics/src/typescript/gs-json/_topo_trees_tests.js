...
exports.test_TopoTree_constructor = test_TopoTree_constructor;
function test_TopoTree_hasTopo() {
    const m = new gs.Model(td.open_box());
...
exports.test_TopoTree_hasTopo = test_TopoTree_hasTopo;
function test_TopoTree_addTopo() {
    const m = new gs.Model(td.open_box());
    const g = m.addGroup("Box");
    const t = new topo_trees_1.TopoTree();
    const f1 = m.getGeom().getObj(0).getFaces()[0];
...
exports.test_TopoTree_addTopo = test_TopoTree_addTopo;
function test_TopoTree_removeTopo2() {
    const m = new gs.Model(td.open_box());
    const g = m.addGroup("Box");
    const t = new topo_trees_1.TopoTree();
    const f1 = m.getGeom().getObj(0).getFaces()[0];
...
exports.test_TopoTree_removeTopo2 = test_TopoTree_removeTopo2;
function test_TopoTree_getTopos2() {
    const MD1 = new gs.Model(td.open_box());
    const G1 = MD1.addGroup("Box");
    const T1 = new topo_trees_1.TopoTree();
    const MD2 = new gs.Model(td.open_box());
    const G2 = MD1.addGroup("Box");
    const T2 = new topo_trees_1.TopoTree();
    const f1 = MD1.getGeom().getObj(0).getFaces()[0];
    const f2 = MD1.getGeom().getObj(0).getFaces()[1];
    const f3 = MD1.getGeom().getObj(0).getFaces()[2];
    const f4 = MD1.getGeom().getObj(0).getFaces()[3];
    const f5 = MD1.getGeom().getObj(0).getFaces()[4];
    ...
    for (let k = 0; k < T1.getTopos().length; k++) {
        T2.addTopo(T1.getTopos()[k]);
    }
    if (!(T2.hasTopo(f1.getTopoPath()) &&
...
exports.test_TopoTree_getTopos2 = test_TopoTree_getTopos2;
function test_TopoTree_toArray2() {
    const m = new gs.Model(td.open_box());
    const g = m.addGroup("Box");
    const t = new topo_trees_1.TopoTree();
    const f1 = m.getGeom().getObj(0).getFaces()[0];
    const f1_e1 = f1.getEdges()[0];
    const f1_v1 = f1.getVertices()[0];
    const w1 = m.getGeom().getObj(0).getWires()[0];
    const w1_e1 = w1.getEdges()[0];
    const w1_v1 = w1.getVertices()[0];
    if (!(arr_1.Arr.equal(t.toArray()[0], []) && arr_1.Arr.equal(t.toArray()[1], []) && arr_1.Arr.equal(t.toArray()[2], [])
        && arr_1.Arr.equal(t.toArray()[3], []) && arr_1.Arr.equal(t.toArray()[4], []) && arr_1.Arr.equal(t.toArray()[5], []))) {
        return false;
    }
    t.addTopo(f1.getTopoPath());
    if (!(!arr_1.Arr.equal(t.toArray()[0], []) && arr_1.Arr.equal(t.toArray()[1], []) && arr_1.Arr.equal(t.toArray()[2], [])
...
exports.test_TopoTree_toArray2 = test_TopoTree_toArray2;
function test_TopoTree_fromArray2() {
    const m = new gs.Model(td.open_box());
    const g = m.addGroup("Box");
    const t = new topo_trees_1.TopoTree();
    const f1 = m.getGeom().getObj(0).getFaces()[0];
    ...
    t.addTopo(w1_e1.getTopoPath());
    t.addTopo(w1_v1.getTopoPath());
    const m2 = new gs.Model(td.open_box());
    const g2 = m2.addGroup("Box");
    const t2 = new topo_trees_1.TopoTree();
    t2.fromArray(t.toArray());
    if (!(g2.hasTopo(f1) && g2.hasTopo(w1) &&
        g2.hasTopo(f1_e1) && g2.hasTopo(f1_v1) &&
        g2.hasTopo(w1_e1) && g2.hasTopo(w1_v1))) {
        return false;
    }
    return true;
}
exports.test_TopoTree_fromArray2 = test_TopoTree_fromArray2;
function test_TopoTree_removeTopo() {
    const m = new gs.Model(td.open_box());
    const g = m.addGroup("Box");
    const t = new topo_trees_1.TopoTree();
    const f1 = m.getGeom().getObj(0).getFaces()[0];
...
exports.test_TopoTree_removeTopo = test_TopoTree_removeTopo;
function test_TopoTree_getTopos() {
    const MD1 = new gs.Model(td.open_box());
    const G1 = MD1.addGroup("Box");
    const T1 = new topo_trees_1.TopoTree();
    const MD2 = new gs.Model(td.open_box());
...
exports.test_TopoTree_getTopos = test_TopoTree_getTopos;
...
//# sourceMappingURL=_topo_trees_tests.js.map