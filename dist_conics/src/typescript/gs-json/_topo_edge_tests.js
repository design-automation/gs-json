...
function test_Edge_getGeomType() {
...
exports.test_Edge_getGeomType = test_Edge_getGeomType;
function test_Edge_getVertices() {
    // const k: Kernel = new Kernel(td.open_box());
    // const path: gs.ITopoPathData = {id: 0, tt: 1, ti: 1, st: 0, si: 1};
    // // (0, gs.EGeomType.faces, 1, gs.EGeomType.vertices, 1);
    // const v: gs.IVertex = new gs.Vertex(k, path);
...
exports.test_Edge_getVertices = test_Edge_getVertices;
function test_Edge_getWireOrFace() {
    // const k: Kernel = new Kernel(td.open_box());
...
exports.test_Edge_getWireOrFace = test_Edge_getWireOrFace;
function test_Edge_next() {
    // TODO
    // const k: Kernel = new Kernel(td.open_box());
...
exports.test_Edge_next = test_Edge_next;
function test_Edge_previous() {
    // TODO
    // const k: Kernel = new Kernel(td.open_box());
...
exports.test_Edge_previous = test_Edge_previous;
function test_Edge_edgesSharedPoints() {
    // TODO
...
exports.test_Edge_edgesSharedPoints = test_Edge_edgesSharedPoints;
//# sourceMappingURL=_topo_edge_tests.js.map