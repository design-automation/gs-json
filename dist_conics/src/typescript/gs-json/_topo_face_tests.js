...
function test_Face_getGeomType() {
...
exports.test_Face_getGeomType = test_Face_getGeomType;
function test_Face_getVertices() {
    // const k: Kernel = new Kernel(td.open_box());
    // const path: gs.ITopoPathData = {id: 0, tt: 1, ti: 0}; // (0, gs.EGeomType.faces, 0);
    // const f: gs.IFace = new gs.Face(k, path);
...
exports.test_Face_getVertices = test_Face_getVertices;
function test_Face_getEdges() {
    // const k: Kernel = new Kernel(td.open_box());
    // const path: gs.ITopoPathData = {id: 0, tt: 1, ti: 0}; // (0, gs.EGeomType.faces, 0);
    // const f: gs.IFace = new gs.Face(k, path);
...
exports.test_Face_getEdges = test_Face_getEdges;
function test_Face_numVertices() {
    // const k: Kernel = new Kernel(td.open_box());
    // const path: gs.ITopoPathData = {id: 0, tt: 1, ti: 0}; // (0, gs.EGeomType.faces, 0);
    // const f: gs.IFace = new gs.Face(k, path);
...
exports.test_Face_numVertices = test_Face_numVertices;
function test_Face_numEdges() {
    // const k: Kernel = new Kernel(td.open_box());
    // const path: gs.ITopoPathData = {id: 0, tt: 1, ti: 0}; // (0, gs.EGeomType.faces, 0);
    // const f: gs.IFace = new gs.Face(k, path);
...
exports.test_Face_numEdges = test_Face_numEdges;
function test_Face_isClosed() {
    // const k: Kernel = new Kernel(td.open_box());
    // const path: gs.ITopoPathData = {id: 0, tt: 1, ti: 0}; // (0, gs.EGeomType.faces, 0);
    // const f: gs.IFace = new gs.Face(k, path);
...
exports.test_Face_isClosed = test_Face_isClosed;
function test_Face_facesSharedPoints() {
...
exports.test_Face_facesSharedPoints = test_Face_facesSharedPoints;
//# sourceMappingURL=_topo_face_tests.js.map