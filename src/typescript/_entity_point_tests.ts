...
describe("Tests for Point class", () => {
    it("test_point_getGeomType", () => {
        expect( test_point_getGeomType() ).toBe(true);
    });
    it("test_point_setPosition", () => {
        expect( test_point_setPosition() ).toBe(true);
    });
    it("test_point_getPosition", () => {
        expect( test_point_getPosition() ).toBe(true);
    });
    it("test_point_getVertices", () => {
    expect( test_point_getVertices() ).toBe(true);
    });
    it("test_point_exists", () => {
    expect( test_point_exists() ).toBe(true);
    });
});
