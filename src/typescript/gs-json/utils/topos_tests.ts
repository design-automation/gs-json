...
export function test_Topo_getGroups(): boolean {
    const m: gs.IModel = new gs.Model(td.box_with_attribs());
    const path: gs.ITopoPathData = {id: 0, tt: 1, ti: 0, st: 0, si: 0};
    // (0, gs.EGeomType.faces, 0, gs.EGeomType.vertices, 0);
...
//     const path3: gs.ITopoPathData = {id: 0, tt: 0, ti: 0, st: 0, si: 0};
// (0, gs.EGeomType.wires, 0, gs.EGeomType.edges, 1);
//     const path4: gs.ITopoPathData = {id: 0, tt: 0, ti: 0, st: 0, si: 0};
// (0, gs.EGeomType.wires, 0, gs.EGeomType.edges, 1);
...
//     const path1: gs.ITopoPathData = {id: 0, tt: 1, ti: 0}; //(0, gs.EGeomType.faces, 0, gs.EGeomType.edges, 0);
//     const path2: gs.ITopoPathData = {id: 0, tt: 0, ti: 0, st: 0, si: 0};
// (1, gs.EGeomType.wires, 4, gs.EGeomType.vertices, 9);
...
//     const k: Kernel = new Kernel(td.open_box());
//     const path0: gs.ITopoPathData = {id: 0, tt: 1, ti: 0, st: 0, si: 0};
// (0, gs.EGeomType.faces, 0, gs.EGeomType.vertices, 0);
//     const v0: gs.IVertex = new gs.Vertex(k, path0);
//     if((v0.verticesSamePosition().length != 2)){return false;}
//     const path1: gs.ITopoPathData = {id: 0, tt: 1, ti: 0, st: 0, si: 1};
// (0, gs.EGeomType.faces, 0, gs.EGeomType.vertices, 1);
//     const v1: gs.IVertex = new gs.Vertex(k, path1);
//     if((v1.verticesSamePosition().length != 2)){return false;}
//     const path2: gs.ITopoPathData = {id: 0, tt: 1, ti: 0, st: 0, si: 2};
// (0, gs.EGeomType.faces, 0, gs.EGeomType.vertices, 2);
//     const v2: gs.IVertex = new gs.Vertex(k, path2);
//     if((v2.verticesSamePosition().length != 2)){return false;}
//     const path3: gs.ITopoPathData = {id: 0, tt: 1, ti: 0, st: 0, si: 3};
// (0, gs.EGeomType.faces, 0, gs.EGeomType.vertices, 3);
