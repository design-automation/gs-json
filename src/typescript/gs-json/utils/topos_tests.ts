...
export function test_Topo_constructor(): boolean {
    ...
    const path1: ITopoPathData = {id: 0, tt: 1, ti: 0, st: 1, si: 0}; //(0, gs.EGeomType.faces, 0, gs.EGeomType.edges, 0);
    const path2: ITopoPathData = {id: 0, tt: 1, ti: 0, st: 0, si: 0}; //(0, gs.EGeomType.faces, 0, gs.EGeomType.vertices, 0);
    const path3: ITopoPathData = {id: 0, tt: 0, ti: 0, st: 1, si: 0}; //(0, gs.EGeomType.wires, 0, gs.EGeomType.edges, 0);
    const path4: ITopoPathData = {id: 0, tt: 0, ti: 0, st: 0, si: 0}; //(0, gs.EGeomType.wires, 0, gs.EGeomType.vertices, 0);
...
export function test_Topo_getObjID(): boolean {
    const k: Kernel = new Kernel(td.open_box());
    const path: ITopoPathData = {id: 0, tt: 1, ti: 0, st: 1, si: 0}; //(0, gs.EGeomType.faces, 0, gs.EGeomType.edges, 0);
...
export function test_Topo_getAttribValue(): boolean {
    const m: gs.IModel = new Model(td.box_with_attribs());
...
export function test_Topo_getGroups(): boolean {
    ...
    const path: ITopoPathData = {id: 0, tt: 1, ti: 0, st: 0, si: 0}; //(0, gs.EGeomType.faces, 0, gs.EGeomType.vertices, 0);
...
export function test_Vertex_getGeomType(): boolean {
    const k: Kernel = new Kernel(td.open_box());
    const path: ITopoPathData = {id: 0, tt: 1, ti: 1, st: 0, si: 1}; //(0, gs.EGeomType.faces, 1, gs.EGeomType.vertices, 1);
...
//     const k: Kernel = new Kernel(td.open_box());
//     const path0: ITopoPathData = {id: 0, tt: 1, ti: 0, st: 0, si: 0}; //(0, gs.EGeomType.faces, 0, gs.EGeomType.vertices, 0);
//     const v0: gs.IVertex = new gs.Vertex(k, path0);
//     if((v0.verticesSamePosition().length != 2)){return false;}
//     const path1: ITopoPathData = {id: 0, tt: 1, ti: 0, st: 0, si: 1}; //(0, gs.EGeomType.faces, 0, gs.EGeomType.vertices, 1);
//     const v1: gs.IVertex = new gs.Vertex(k, path1);
//     if((v1.verticesSamePosition().length != 2)){return false;}
//     const path2: ITopoPathData = {id: 0, tt: 1, ti: 0, st: 0, si: 2}; //(0, gs.EGeomType.faces, 0, gs.EGeomType.vertices, 2);
//     const v2: gs.IVertex = new gs.Vertex(k, path2);
//     if((v2.verticesSamePosition().length != 2)){return false;}
//     const path3: ITopoPathData = {id: 0, tt: 1, ti: 0, st: 0, si: 3}; //(0, gs.EGeomType.faces, 0, gs.EGeomType.vertices, 3);
...
export function test_Edge_getWireOrFace(): boolean {
    const k: Kernel = new Kernel(td.open_box());
    const path1: ITopoPathData = {id: 0, tt: 1, ti: 1, st: 1, si: 0}; //(0, gs.EGeomType.faces, 1, gs.EGeomType.edges, 0);
    const e1: gs.IEdge = new gs.Edge(k, path1);
    const path2: ITopoPathData = {id: 0, tt: 0, ti: 0, st: 1, si: 0}; //(0, gs.EGeomType.wires, 0, gs.EGeomType.edges, 0);
...
export function test_Wire_getGeomType(): boolean {
    const k: Kernel = new Kernel(td.open_box());
    const path: ITopoPathData = {id: 0, tt: 0, ti: 0}; //(0, gs.EGeomType.wires, 0);
...
export function test_Face_getGeomType(): boolean {
    const k: Kernel = new Kernel(td.open_box());
    const path: ITopoPathData = {id: 0, tt: 1, ti: 0}; //(0, gs.EGeomType.faces, 0);
...
export function test_Face_facesSharedPoints(): boolean {
    ...
    const path1: ITopoPathData = {id: 0, tt: 1, ti: 0}; //(0, gs.EGeomType.faces, 0);
    ...
    const path00: ITopoPathData = {id: 0, tt: 1, ti: 0}; //(0, gs.EGeomType.faces, 0);
    const f00: gs.IFace = new gs.Face(k2, path00);
    const path01: ITopoPathData = {id: 0, tt: 1, ti: 1}; //(0, gs.EGeomType.faces, 1);
    const f01: gs.IFace = new gs.Face(k2, path01);
    const path02: ITopoPathData = {id: 0, tt: 1, ti: 2}; //(0, gs.EGeomType.faces, 2);
    const f02: gs.IFace = new gs.Face(k2, path02);
    const path03: ITopoPathData = {id: 0, tt: 1, ti: 3}; //(0, gs.EGeomType.faces, 3);
    const f03: gs.IFace = new gs.Face(k2, path03);
    const path04: ITopoPathData = {id: 0, tt: 1, ti: 4}; //(0, gs.EGeomType.faces, 4);
    const f04: gs.IFace = new gs.Face(k2, path04);
    const path05: ITopoPathData = {id: 0, tt: 1, ti: 5}; //(0, gs.EGeomType.faces, 5);
    const f05: gs.IFace = new gs.Face(k2, path05);
    const path06: ITopoPathData = {id: 0, tt: 1, ti: 6}; //(0, gs.EGeomType.faces, 6);
    const f06: gs.IFace = new gs.Face(k2, path06);
    const path07: ITopoPathData = {id: 0, tt: 1, ti: 7}; //(0, gs.EGeomType.faces, 7);
    const f07: gs.IFace = new gs.Face(k2, path07);
    const path08: ITopoPathData = {id: 0, tt: 1, ti: 8}; //(0, gs.EGeomType.faces, 8);
...
//     const path: ITopoPathData = {id: 0, tt: 1, ti: 0}; //(0, gs.EGeomType.faces, 0, gs.EGeomType.edges, 0);
...
//     const path: ITopoPathData = {id: 0, tt: 1, ti: 0}; //(0, gs.EGeomType.faces, 0, gs.EGeomType.edges, 0);
//     const e: gs.IEdge = new gs.Edge(k, path)
//     const path1: ITopoPathData = {id: 0, tt: 1, ti: 0}; //(0, gs.EGeomType.faces, 0, gs.EGeomType.edges, 0);
//     const path2: ITopoPathData = {id: 0, tt: 1, ti: 0}; //(0, gs.EGeomType.faces, 1, gs.EGeomType.edges, 0);
//     const path3: ITopoPathData = {id: 0, tt: 0, ti: 0, st: 0, si: 0}; //(0, gs.EGeomType.wires, 0, gs.EGeomType.edges, 1);
//     const path4: ITopoPathData = {id: 0, tt: 0, ti: 0, st: 0, si: 0}; //(0, gs.EGeomType.wires, 0, gs.EGeomType.edges, 1);
...
//     const path1: ITopoPathData = {id: 0, tt: 1, ti: 0}; //(0, gs.EGeomType.faces, 0, gs.EGeomType.edges, 0);
//     const path2: ITopoPathData = {id: 0, tt: 0, ti: 0, st: 0, si: 0}; //(1, gs.EGeomType.wires, 4, gs.EGeomType.vertices, 9);
