...
export function test_Groups_getChildGroups():boolean{
	...
	let grp3:gs.IGroup = m.addGroup("test3");
	let grp4:gs.IGroup = m.addGroup("test4", "test1");			
// if (grp1.getChildGroups() != [grp2.getName(),grp4.getName()]) {return false;}	
// if (grp2.getChildGroups() != []) {return false;}
// if (grp3.getChildGroups() != []) {return false;}
// if (grp4.getChildGroups() != []) {return false;}
	return true;
}
