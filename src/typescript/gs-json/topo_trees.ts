...
import {EGeomType, mapTTPathIndexToGeomType, mapSTPathIndexToGeomType} from "./enums";
import {ITreeBranch2, ITreeBranch3} from "./ifaces_trees";
 ...
 */
class TreeBranch2 implements ITreeBranch2 {
 ...
 * This class is only used internally by the TopoTree class.
 */
class TreeBranch3 implements ITreeBranch3 {
    private _tree: Map<number, ITreeBranch2>;
