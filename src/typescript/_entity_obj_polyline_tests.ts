...
describe("Tests for Polyline class", () => {
    it("test_Polyline_getObjType", () => {
        expect( test_Polyline_getObjType() ).toBe(true);
    });
    it("test_Polyline_setIsClosed", () => {
        expect( test_Polyline_setIsClosed() ).toBe(true);
    });
    it("test_Polyline_insertVertex", () => {
        expect( test_Polyline_insertVertex() ).toBe(true);
    });
    it("test_Polyline_toString", () => {
        expect( test_Polyline_toString() ).toBe(true);
    });
});
