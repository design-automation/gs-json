...
describe("Tests for Edge class", () => {
    it("test_Edge_getGeomType", () => {
        expect( test_Edge_getGeomType() ).toBe(true);
    });
    it("test_Edge_getVertices", () => {
        expect( test_Edge_getVertices() ).toBe(true);
    });
    it("test_Edge_getWireOrFace", () => {
        expect( test_Edge_getWireOrFace() ).toBe(true);
    });
    it("test_Edge_next", () => {
        expect( test_Edge_next() ).toBe(true);
    });
    it("test_Edge_previous", () => {
        expect( test_Edge_previous() ).toBe(true);
    });
    it("test_Edge_edgesSharedPoints", () => {
        expect( test_Edge_edgesSharedPoints() ).toBe(true);
    });
});
