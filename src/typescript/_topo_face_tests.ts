...
describe("Tests for Face class", () => {
    it("test_Face_getGeomType", () => {
        expect( test_Face_getGeomType() ).toBe(true);
    });
    it("test_Face_getVertices", () => {
        expect( test_Face_getVertices() ).toBe(true);
    });
    it("test_Face_getEdges", () => {
        expect( test_Face_getEdges() ).toBe(true);
    });
    it("test_Face_numVertices", () => {
        expect( test_Face_numVertices() ).toBe(true);
    });
    it("test_Face_numEdges", () => {
        expect( test_Face_numEdges() ).toBe(true);
    });
    it("test_Face_isClosed", () => {
        expect( test_Face_isClosed() ).toBe(true);
    });
    it("test_Face_facesSharedPoints", () => {
        expect( test_Face_facesSharedPoints() ).toBe(true);
    });
});
